...
def main():
    ...
    if overall_stats['rank1_scores']:
        ...
        print(f"平均 Rank-1: {summary['mean_rank1']:.4f}")
        print(f"平均 Rank-5: {summary['mean_rank5']:.4f}")
        print(f"平均 mAP: {summary['mean_mAP']:.4f}")
        print(f"平均 AUC: {summary['mean_AUC']:.4f}")
        print(f"平均 ACC: {summary['mean_ACC']:.4f}")
        print(f"平均 NMI: {summary['mean_NMI']:.4f}")
        print(f"平均相对误差 (RE): {summary['mean_RE']:.4f}")
